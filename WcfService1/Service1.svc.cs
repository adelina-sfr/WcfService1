...
namespace WcfService1
{
    ...
    {
        SqlConnection con = new SqlConnection("Data Source=DESKTOP-5C1L09A; Initial Catalog =MyTestDB; Persist Security info = true; User ID = sa; Password = 12345; Pooling = False");
